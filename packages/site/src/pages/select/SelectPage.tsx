...
import { Padding, Select } from "@nightfall-ui/components";
      ...
      <Padding value={"0 0 0 7rem"}>
        <Select onChange={(e: any) => setValue(e.target.value)} value={value}>
          ...
          <Select.Option value={"long"}>
            ...
            corporis dolore eaque facere facilis fugiat, molestiae placeat,
            rerum soluta temporibus veniam voluptatem. Aut dolor doloribus quae
            quia, sint tempora?
          </Select.Option>
        </Select>
      </Padding>
